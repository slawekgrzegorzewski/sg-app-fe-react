    ...
    if (short) {
        return (
            <Stack direction="column" key={loan.publicId} onClick={onClick}
                ...
                <Stack direction="row" justifyContent="space-between" alignItems="baseline" gap={2}>
                    <Typography><StandOutText standOutBy="bold">{loan.name}</StandOutText></Typography>
        ...
        return (
            <Stack direction="column" spacing={0.5} key={loan.publicId} sx={{minWidth: 0}}>
                ...
                <Typography>Kwota pożyczki: <StandOutText><CurrencyAmountDisplay {...loan.paidAmount} /></StandOutText></Typography>
                <Typography>Pozostały kapitał: <StandOutText><CurrencyAmountDisplay {...remainingCapital(loan)} /></StandOutText></Typography>
