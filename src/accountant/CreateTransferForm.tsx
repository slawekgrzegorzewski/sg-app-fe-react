        ...
        <Form
            onSave={transfer => {
                const fromCurrency: string =
                    accounts.find(a => a.publicId === transfer.fromAccountPublicId || '')?.currentBalance.currency
                        .code || '';
                const toCurrency: string =
                    accounts.find(a => a.publicId === transfer.toAccountPublicId || '')?.currentBalance.currency.code ||
                    '';
